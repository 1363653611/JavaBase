...
//        thenApplyAsyncWithExecutorExample();
    ...
    static void completedFutureExample() {
        ...
        //输出为true
        System.out.println(StringUtils.equals("message", cf.getNow(null)));
    }
    ...
    private static void assertEquals(String message, String join) {
        System.out.println(StringUtils.equals(message,join));
    }
    ...
    private static void assertNull(String now) {
        System.out.println("assertNull:" + now);
    }

    private static void assertFalse(boolean daemon) {
        System.out.println("assertEquals："+ daemon);
    }

    private static void assertTrue(boolean startsWith) {
        System.out.println("assertTrue:" + startsWith);
    }

    private static void assertTrue(String result, boolean b) {
        System.out.println(result+ " <---> " + b);
    }

    private static void fail(String fall) {
